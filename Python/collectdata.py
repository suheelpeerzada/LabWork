...
while True:
    ...
    count = {
             ...
             'victory': len(os.listdir(directory+"victory")),
    ...
    if interrupt & 0xFF == ord('a'):
        cv2.imwrite(directory+'hi/'+str(count['hi'])+'.png',frame)
    ...
    if interrupt & 0xFF == ord('e'):
        cv2.imwrite(directory+'ok/'+str(count['ok'])+'.png',frame)
    if interrupt & 0xFF == ord('f'):
        cv2.imwrite(directory+'victory/'+str(count['victory'])+'.png',frame)
